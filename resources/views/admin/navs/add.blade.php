@extends('layouts.admin')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 自定义菜单管理
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/navs/create')}}"><i class="fa fa-plus"></i>添加菜单</a>
                <a href="{{url('admin/navs')}}"><i class="fa fa-recycle"></i>全部菜单</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
