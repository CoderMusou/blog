                    ...
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                <option value=" @if($field['cate_pid']==0)selected="selected"@endif">==顶级分类==</option>
                                @foreach($data as $v)
                                <option value="{{$v->cate_id}}" @if($field['cate_pid']==$v->cate_id)selected="selected"@endif>{{$v->cate_name}}</option>
                                    @endforeach
                            </select>
                        </td>
                    </tr>
